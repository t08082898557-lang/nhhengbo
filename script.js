...
const products = [
  { model: "HB-330C", img: "product-mains/alibaba-hb-330c-main.png", en: ["Triangle Roadside Warning Lamp · Rechargeable", "Type-C rechargeable version of the HB-330 triangle warning light."], zh: ["HB-330C 三角道路警示灯充电款", "HB-330 三角警示灯的 Type-C 充电版本。"] },
  { model: "HB-331C", img: "product-mains/alibaba-hb-331c-main.png", en: ["Triangle Work Warning Light · Rechargeable", "Type-C rechargeable version of the HB-331 triangle warning light."], zh: ["HB-331C 三角工作警示灯充电款", "HB-331 三角警示灯的 Type-C 充电版本。"] },
  ...
  { model: "HB-328", img: "product-mains/alibaba-hb-328-main.png", en: ["LED Road Warning Light", "Multi-mode LED road warning light with strong visibility."], zh: ["LED 道路警示灯", "多模式道路警示灯，亮度高、穿透力强。"] },
  ...
  { model: "HB-330", img: "product-mains/alibaba-hb-330-main.png", en: ["Triangle Roadside Warning Lamp", "Foldable triangle warning lamp for night roadside emergencies."], zh: ["三角道路警示灯", "折叠式三角警示灯，适合夜间道路应急。"] },
  { model: "HB-331", img: "product-mains/alibaba-hb-331-main.png", en: ["Triangle Work Warning Light", "Portable triangle warning light with strong safety illumination."], zh: ["三角工作警示灯", "便携式三角警示灯，安全警示效果明显。"] },
