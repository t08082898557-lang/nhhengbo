...
document.querySelectorAll(".signature-products button, .flagship-board button, .hero-sourcing-card button, .new-series-card, .bundle-grid button").forEach(button => {
  button.addEventListener("click", () => openProductModal(button.dataset.model));
});
