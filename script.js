...
function productBadges(item) {
  ...
  if (["HB-328", "HB-329", "HB-362", "HB-363C", "HB-363B"].includes(item.model)) badges.push(t("tagHot"));
  ...
  if (["HB-362", "HB-363C", "HB-363B", "HB-328", "HB-329"].includes(item.model)) badges.push(t("tagOem"));
...
const featuredProductOrder = [
  ...
  "HB-362", "HB-321", "HB-363B", "XG-C8505-COB",
  "HB-330",
