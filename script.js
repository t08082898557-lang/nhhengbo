...
const translations = {
  en: {
    ...
    qualityEyebrow: "Quality & Service", qualityTitle: "ISO 9001-oriented quality management for stable export orders.", qualityText: "We build our daily production around ISO 9001 quality management principles, with documented checkpoints from incoming materials to final shipment.", qualityIso: "Process-based quality management", qualityStages: "Incoming, in-process and final checks", qualityAql: "Sampling inspection before shipment", certEyebrow: "Certificates", certTitle: "Third-party compliance documents for export markets.", certText: "Selected certificates are available for buyer review, covering CE/EMC, FCC and RoHS compliance for emergency warning light and work light product series.", certCe: "Electromagnetic compatibility certificate", certFcc: "Supplier's Declaration of Conformity", certRohs: "Restriction of hazardous substances certificate", certOpen: "View PDF",
