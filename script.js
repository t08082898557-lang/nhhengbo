...
const advantages = [
  ...
  { num: "05", en: ["Stable quality", "QC system from materials to finished products."], zh: ["品质稳定", "从原材料、生产过程到成品出货均有质检控制。"] },
...
const translations = {
  en: {
    ...
    factoryEyebrow: "Manufacturing Excellence", factoryTitle: "End-to-end capability, built for global brands.", factoryText: "We combine production ownership with export service: injection molding, precision tooling, assembly lines, packaging warehouse and dedicated quality inspection are coordinated under one system.",
    ...
    qualityEyebrow: "Quality & Service", qualityTitle: "Strict QC from raw materials to finished products.", qualityText: "Our workflow is designed for repeatable export quality: incoming inspection, production control, functional testing, packaging checks and shipment coordination.",
  ...
  zh: {
    ...
    proof1: "自有工厂生产", proof2: "外贸服务团队", proof3: "OEM/ODM品牌支持", signatureEyebrow: "核心系列", signatureTitle: "为高可见度而设计，为真实安全场景而制造。", flagshipEyebrow: "旗舰产品矩阵", flagshipTitle: "一条产品线，覆盖多种安全场景。", flagshipText: "从迷你警示灯、工作灯，到安全信标和道路应急灯，帮助客户快速搭建市场产品组合。", prestige1: "现代化生产基地", prestige2: "核心制造模块", prestige3: "专业生产人员", prestige4: "出口认证支持", metricFactory: "现代化工厂", metricTeam: "专业团队", metricService: "全链路定制", metricExport: "全球交付",
    ...
    factoryEyebrow: "制造实力", factoryTitle: "端到端生产能力，服务全球品牌。", factoryText: "我们将生产制造与出口服务整合：注塑、精密模具、装配线、包装仓储和专职质检在同一体系内协同。",
    cap1: "先进注塑", cap2: "精密模具车间", cap3: "标准化装配", cap4: "环保包装", cap5: "专职质量控制", cap6: "可扩展产能",
    customEyebrow: "OEM/ODM 定制", customTitle: "从想法到品牌成品，一个团队全程负责。",
    qualityEyebrow: "质量与服务", qualityTitle: "从原材料到成品的严格质检。", qualityText: "流程覆盖来料检验、生产控制、功能测试、包装检查和出货协同，保障稳定出口品质。",
